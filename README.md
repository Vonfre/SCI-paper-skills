...
[![Version](https://img.shields.io/badge/version-0.6.12-0f766e)](manifest.yaml)
...
| 原始数据、公共数据集、仓库登录号、分析输出、代码或作图文件 | 先识别数据质量、统计状态、图件证据、数据集适用性、引用/可用性和可复现性风险，再进入写作 |
...
- 检索并整合公共数据集、仓库登录号、benchmark 资源、source data、软件/模型发布和相关论文，把它们连接到 claim、figure、citation 和 data availability。
