...
| 4 | `sci-result-to-claim` | results, figure descriptions, `analysis_registry`, `source_ledger`, `journal_landscape` | `analysis_registry` updates, `claim_registry` with IDs `C#`, evidence gaps, safe wording | no results or observations; analysis-derived claims lack provenance/statistical status | `sci-core-story-finder` |
...
| 9 | `sci-draft-mimic` | `journal_landscape`, `journal_landscape.journal_format_profile`, `analysis_registry`, `source_ledger`, `claim_registry`, `figure_registry`, `data_availability_plan`, `storyline`, `reviewer_risk` | `draft_registry`, section drafts, open needs/citations, high-risk claims, format and analysis/source-data notes | missing journal/format/analysis/claim/story/figure gates | `sci-paragraph-coach` or `sci-citation-control` |
...
| 13 | `sci-submission-revision` | `journal_landscape`, `journal_landscape.journal_format_profile`, `analysis_registry`, `draft_registry`, `figure_registry`, `citation_audit`, `data_availability_plan`, reviewer comments | `data_availability_plan`, `submission_package`, file checklist, format compliance check, rebuttal matrix, final readiness | placeholders, unknown requirements, unsupported claims, unresolved format/data/source-code issues | final repair or submission |
...
6. `sci-submission-revision` must not mark the package ready while `[NEED: ...]`, `[CITE: ...]`, unresolved journal-format placeholders, data/source-code gaps, or missing dataset/software citations remain in submission-facing text.
