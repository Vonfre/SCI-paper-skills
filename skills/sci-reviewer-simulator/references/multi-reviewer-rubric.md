# Multi-Reviewer Rubric

Use this rubric for structured reviewer simulation before submission or major revision.

## Reviewer Panel

| Reviewer Mode | Primary Question | Typical Blocking Risk |
|---|---|---|
| Editor screen | Is this within scope, timely, and strong enough for this journal? | Desk rejection for poor fit or low novelty. |
| Field expert | Does prior work already cover the claim? | Novelty overstated or important literature missing. |
| Method reviewer | Are design, controls, statistics, and reproducibility adequate? | Unsupported conclusions or invalid analysis. |
...
| Dimension | 1 | 3 | 5 |
|---|---|---|---|
| Journal fit | Clear mismatch | Possible but risky | Strong scope and article-type match |
| Novelty | Already known | Incremental but framed | Clear gap with evidence |
| Evidence strength | Claims exceed data | Some claims need softening | Claims match data depth |
...
If AI has materially drafted, rewritten, analyzed, or reviewed the manuscript, remind the user to follow the target journal's AI disclosure policy. Do not invent a disclosure statement unless the target journal policy is known.
