...
- Strong: direct and multiple sources plus user data likely sufficient.
- Moderate: plausible but needs controls or clearer mechanism.
- Weak: indirect literature only.
- Contradictory: literature suggests an alternative explanation.
- Unknown: not enough literature found.

## For Open Research Directions
